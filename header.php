                        ...
                        <div class="col-lg-12 col-sm-12">
                            <?php if (isset($page) and $page == "home") { ?>
                                <div class="owl-carousel" id="banner-slider" data-slider-id="1">
                                    <div class="item">
                                        <div class="selekt_banner" style="background-image: url(./images/banner1.jpg);">
                            ...
                            <?php } elseif (isset($page) and $page == "franchise") { ?>
                                <div class="inner-page-banner">
                                    <h1>Franchise</h1>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-3 col-sm-4 col-5">
                                <ul class="main-nav hidden-md-down">
                                    ...
                                    <li><a href="franchise.php" class="<?php
                                                                        if (isset($page) and $page == "franchise") {
                                                                            echo "active";
                                                                        } ?>">Franchise</a></li>
                           ...
                           <li><span>Call for Order</span>
                            ...
                            <div class="col-lg-2 col-sm-3 col-md-4 col-4 text-sm-right  wow fadeInDown">
                                <a href="franchise.php" class="franchise-btn">Franshise Info</a>
                            </div>
                        </div>
                    </div>
                </div>
